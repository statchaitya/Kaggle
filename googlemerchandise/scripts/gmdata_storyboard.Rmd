---
title: "Google Merchandise Data - Storyboard"
output: 
...
### Referral traffic coming from which locations converts the most and the least?
...
ggplot(data = s1_ggdata %>%
  ...
  labs(x = "Location", 
       y = "Proportion",
       fill = "Metric",
       title = "High Referral Visit Locations",
       subtitle = "Conversion Rate Comparisons") +
...
Among locations from where at least 1000 referral visits are recorded, New York, Ann Arbor and Chicago have most conversions while London and Japan have least conversions.

Potential Action: Curtail the referral campaigns running in locations like London and Japan.
