# -*- coding: utf-8 -*-
"""
Created on Sun Apr  8 22:40:34 2018
...
train['app_dloads_log1p'].fillna(0, inplace=True)
train['app_dloads_log1p'] = train['app_dloads_log1p'].astype('uint16')

pca = PCA(n_components=6)
pca.fit(train)

tr = pca.transform(train)
del pca
tr = pd.DataFrame(tr)
